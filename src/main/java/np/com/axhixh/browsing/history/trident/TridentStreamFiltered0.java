 ...
 * @author ashish
 */
public class TridentStreamFiltered0 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        topology.newStream("history-source", new HistorySpout(history))
                .shuffle()
                .stateQuery(placeState, new Fields("place_id", "visit_date"), new PlaceQuery(), new Fields("vdate"))
        ...
        cluster.submitTopology("heatmap", conf, topology.build());
